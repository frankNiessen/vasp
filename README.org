...
Create the file '.vasprc' in your homedirectory.

This is a file needed to set paramaters for your job scheduler. Below is an example, just replace fields as necessary.

#+BEGIN_SRC python
# adjust these for the your system

vasp.executable.serial = vasp_neb
vasp.executable.parallel = vasp_neb
